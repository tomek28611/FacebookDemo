...
const RightSidebar = () => {
  ...
  return (
    <div>
        <div className="hidden lg:block pt-4 sm:pt-9 pr-7">
            <div className="flex items-center">
                <p className="pr-5 font-bold">Contacts</p>
            ...
            <div className="space-y-4 mt-4">
                {profiles.map((profile) => (
                    ...
                    <div className="relative flex w-12 h-12">
                        ...
                        <div className="absolute w-3 h-3 bg-green-500 
                        rounded-full bottom-0 right-1 border-2 border-white"></div>
                    </div>
